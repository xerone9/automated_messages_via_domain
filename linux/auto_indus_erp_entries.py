...
def read_pdf(file):
    full_location = '/home/xerone_9/automated_messages_via_domain/'
    pdf_file = full_location + file
    vouchers = []
...
def connect_and_pass_sql(sql_code):
    if sql_code:
        os.environ['LD_LIBRARY_PATH'] = '/home/rubick/Automation_Tests/instantclient_21_13'
        os.environ['PATH'] = '/home/rubick/Automation_Tests/instantclient_12_2:' + os.environ['PATH']
        ...
        os.environ['PATH'] = '/home/rubick/Automation_Tests/instantclient_21_13:' + os.environ['PATH']
